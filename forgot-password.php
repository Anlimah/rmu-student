                            ...
                            <div class="card loginFormContainer" style="margin-bottom: 10px; min-width: 360px; max-width: 360px;">
                                ...
                                <div style="margin: 0px 12% !important">
                                    <form id="appLoginForm">
                                        <div class="mb-4">
                                            <input type="email" id="email-address" name="email-address" class="form-control form-control-lg form-control-login" placeholder="Enter email address">
                                        </div>
                                        <div class="mb-4">
                                    ...
                                    <div class="row" style="margin-bottom:30px;">
                                        <a href="login.php" style="color: #003262 !important; text-decoration:underline !important">Login Here</a>
                                    </div>
                                </div>
                            </div>
                        </div>
