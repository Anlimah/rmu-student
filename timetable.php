...
<body>
            ...
            <main class="app__content">
                ...
                <div class="card mb-6">
                    <div class="card__header">
                        <h3 class="card__title">Weekly Timetable</h3>
                    </div>
    ...
    <script>
        jQuery(document).ready(function($) {
            // Load registered courses for timetable display
            $.ajax({
                type: "GET",
                    ...
                    if (result.success) {
                        ...
                        result.message.forEach(function(value) {
                            ...
                            var courseHtml = '<tr>' +
                                ...
                                '<td style="text-align: center;"><span class="badge badge--navy">' + value.category_name + '</span></td>' +
                                '</tr>';
                            $("#timetable-table-body").append(courseHtml);
                        });

                        $("#total-registered-courses").text(total_courses);
                        $("#total-registered-credits").text(total_credits);
                    } else {
                        $("#timetable-table-body").html(
                            '<tr><td colspan="4">' +
