                        ...
                        <div id="course-registration-section">
                            <div id="course-registration-form-section">
                                ...
                                <form id="register-semester-courses-form" method="post" enctype="multipart/form-data">
                                    ...
                                    <div id="display-message" role="alert"></div>
            ...
            $(document).on("submit", "#register-semester-courses-form", function(e) {
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        console.log(result);
                        if (result.success) {
                            $("#display-message").prop("class", "alert alert-success alert-dismissible d-flex align-items-center").html(
                                '<i class="bi bi-check-circle-fill me-2" role="img"></i>' +
                            ...
                            $("#display-message").prop("class", "alert alert-danger alert-dismissible d-flex align-items-center").html(
                                '<i class="bi bi-exclamation-triangle-fill me-2" role="img"></i>' +
                                '<div>' + result.message + '</div>' +
                                '<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>'
                            );
                        }
